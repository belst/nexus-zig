...
CIMGUI_API ImGuiID cimgui::cImHashDataEx(const void* data, size_t data_size, ImU32 seed)
{
...
CIMGUI_API ImGuiID cimgui::cImHashStrEx(const char* data, size_t data_size, ImU32 seed)
{
...
CIMGUI_API ImGuiID cimgui::cImHash(const void* data, int size)
{
    return ::ImHash(data, size);
}

CIMGUI_API ImGuiID cimgui::cImHashEx(const void* data, int size, ImU32 seed)
{
    return ::ImHash(data, size, seed);
}
...
CIMGUI_API int cimgui::cImTextStrToUtf8(char* buf, int buf_size, const ImWchar* in_text, const ImWchar* in_text_end)
{
...
CIMGUI_API int cimgui::cImTextStrFromUtf8(ImWchar* buf, int buf_size, const char* in_text, const char* in_text_end)
{
    return ::ImTextStrFromUtf8(buf, buf_size, in_text, in_text_end);
}

CIMGUI_API int cimgui::cImTextStrFromUtf8Ex(ImWchar* buf, int buf_size, const char* in_text, const char* in_text_end, const char** in_remaining)
{
...
CIMGUI_API float  cimgui::cImAbs(float x)
{
    return ::ImAbs(x);
}
...
CIMGUI_API ImGuiDir cimgui::cImGetDirQuadrantFromDelta(float dx, float dy)
{
...
CIMGUI_API void cimgui::ImDrawListSharedData_SetCircleSegmentMaxError(cimgui::ImDrawListSharedData* self, float max_error)
{
    reinterpret_cast<::ImDrawListSharedData*>(self)->SetCircleSegmentMaxError(max_error);
}

CIMGUI_API void cimgui::ImDrawDataBuilder_Clear(cimgui::ImDrawDataBuilder* self)
{
    reinterpret_cast<::ImDrawDataBuilder*>(self)->Clear();
}

CIMGUI_API void cimgui::ImDrawDataBuilder_ClearFreeMemory(cimgui::ImDrawDataBuilder* self)
{
    reinterpret_cast<::ImDrawDataBuilder*>(self)->ClearFreeMemory();
}

CIMGUI_API void cimgui::ImDrawDataBuilder_FlattenIntoSingleLayer(cimgui::ImDrawDataBuilder* self)
{
    reinterpret_cast<::ImDrawDataBuilder*>(self)->FlattenIntoSingleLayer();
}

CIMGUI_API void  cimgui::ImGuiMenuColumns_Update(cimgui::ImGuiMenuColumns* self, int count, float spacing, bool clear)
{
    reinterpret_cast<::ImGuiMenuColumns*>(self)->Update(count, spacing, clear);
}

CIMGUI_API float cimgui::ImGuiMenuColumns_DeclColumns(cimgui::ImGuiMenuColumns* self, float w0, float w1, float w2)
{
    return reinterpret_cast<::ImGuiMenuColumns*>(self)->DeclColumns(w0, w1, w2);
}

CIMGUI_API float cimgui::ImGuiMenuColumns_CalcExtraSpace(const cimgui::ImGuiMenuColumns* self, float avail_w)
{
    return reinterpret_cast<const ::ImGuiMenuColumns*>(self)->CalcExtraSpace(avail_w);
}
...
CIMGUI_API void cimgui::ImGuiNavMoveResult_Clear(cimgui::ImGuiNavMoveResult* self)
{
    reinterpret_cast<::ImGuiNavMoveResult*>(self)->Clear();
}
...
CIMGUI_API void cimgui::ImGuiStackSizes_SetToCurrentState(cimgui::ImGuiStackSizes* self)
{
    reinterpret_cast<::ImGuiStackSizes*>(self)->SetToCurrentState();
}

CIMGUI_API void cimgui::ImGuiStackSizes_CompareWithCurrentState(cimgui::ImGuiStackSizes* self)
{
    reinterpret_cast<::ImGuiStackSizes*>(self)->CompareWithCurrentState();
}
...
CIMGUI_API ImGuiID cimgui::ImGuiWindow_GetIDNoKeepAliveStr(cimgui::ImGuiWindow* self, const char* str)
{
    return reinterpret_cast<::ImGuiWindow*>(self)->GetIDNoKeepAlive(str);
}

CIMGUI_API ImGuiID cimgui::ImGuiWindow_GetIDNoKeepAliveStrEx(cimgui::ImGuiWindow* self, const char* str, const char* str_end)
{
    return reinterpret_cast<::ImGuiWindow*>(self)->GetIDNoKeepAlive(str, str_end);
}

CIMGUI_API ImGuiID cimgui::ImGuiWindow_GetIDNoKeepAlive(cimgui::ImGuiWindow* self, const void* ptr)
{
    return reinterpret_cast<::ImGuiWindow*>(self)->GetIDNoKeepAlive(ptr);
}

CIMGUI_API ImGuiID cimgui::ImGuiWindow_GetIDNoKeepAliveInt(cimgui::ImGuiWindow* self, int n)
{
    return reinterpret_cast<::ImGuiWindow*>(self)->GetIDNoKeepAlive(n);
}
...
CIMGUI_API void cimgui::ImGuiLastItemDataBackup_Backup(cimgui::ImGuiLastItemDataBackup* self)
{
    reinterpret_cast<::ImGuiLastItemDataBackup*>(self)->Backup();
}

CIMGUI_API void cimgui::ImGuiLastItemDataBackup_Restore(const cimgui::ImGuiLastItemDataBackup* self)
{
    reinterpret_cast<const ::ImGuiLastItemDataBackup*>(self)->Restore();
}

CIMGUI_API int         cimgui::ImGuiTabBar_GetTabOrder(const cimgui::ImGuiTabBar* self, const cimgui::ImGuiTabItem* tab)
{
    return reinterpret_cast<const ::ImGuiTabBar*>(self)->GetTabOrder(reinterpret_cast<const ::ImGuiTabItem*>(tab));
}

CIMGUI_API const char* cimgui::ImGuiTabBar_GetTabName(const cimgui::ImGuiTabBar* self, const cimgui::ImGuiTabItem* tab)
{
    return reinterpret_cast<const ::ImGuiTabBar*>(self)->GetTabName(reinterpret_cast<const ::ImGuiTabItem*>(tab));
}
...
CIMGUI_API bool         cimgui::ImGui_IsWindowChildOf(cimgui::ImGuiWindow* window, cimgui::ImGuiWindow* potential_parent)
{
    return ::ImGui::IsWindowChildOf(reinterpret_cast<::ImGuiWindow*>(window), reinterpret_cast<::ImGuiWindow*>(potential_parent));
}
...
CIMGUI_API cimgui::ImRect cimgui::ImGui_GetWindowAllowedExtentRect(cimgui::ImGuiWindow* window)
{
    return ConvertFromCPP_ImRect(::ImGui::GetWindowAllowedExtentRect(reinterpret_cast<::ImGuiWindow*>(window)));
}
...
CIMGUI_API void cimgui::ImGui_FocusWindow(cimgui::ImGuiWindow* window)
{
    ::ImGui::FocusWindow(reinterpret_cast<::ImGuiWindow*>(window));
}

CIMGUI_API void cimgui::ImGui_FocusTopMostWindowUnderOne(cimgui::ImGuiWindow* under_this_window, cimgui::ImGuiWindow* ignore_window)
{
    ::ImGui::FocusTopMostWindowUnderOne(reinterpret_cast<::ImGuiWindow*>(under_this_window), reinterpret_cast<::ImGuiWindow*>(ignore_window));
}
...
CIMGUI_API void cimgui::ImGui_Initialize(cimgui::ImGuiContext* context)
{
    ::ImGui::Initialize(reinterpret_cast<::ImGuiContext*>(context));
}

CIMGUI_API void cimgui::ImGui_Shutdown(cimgui::ImGuiContext* context)
{
...
CIMGUI_API void cimgui::ImGui_AddContextHook(cimgui::ImGuiContext* context, const cimgui::ImGuiContextHook* hook)
{
    ::ImGui::AddContextHook(reinterpret_cast<::ImGuiContext*>(context), reinterpret_cast<const ::ImGuiContextHook*>(hook));
}
...
CIMGUI_API cimgui::ImGuiWindowSettings* cimgui::ImGui_FindWindowSettings(ImGuiID id)
{
    return reinterpret_cast<::cimgui::ImGuiWindowSettings*>(::ImGui::FindWindowSettings(id));
}

CIMGUI_API cimgui::ImGuiWindowSettings* cimgui::ImGui_FindOrCreateWindowSettings(const char* name)
{
    return reinterpret_cast<::cimgui::ImGuiWindowSettings*>(::ImGui::FindOrCreateWindowSettings(name));
}
...
CIMGUI_API cimgui::ImVec2 cimgui::ImGui_ScrollToBringRectIntoView(cimgui::ImGuiWindow* window, cimgui::ImRect item_rect)
{
    return ConvertFromCPP_ImVec2(::ImGui::ScrollToBringRectIntoView(reinterpret_cast<::ImGuiWindow*>(window), ConvertToCPP_ImRect(item_rect)));
}
...
CIMGUI_API ImGuiItemFlags       cimgui::ImGui_GetItemsFlags(void)
{
...
CIMGUI_API ImGuiID              cimgui::ImGui_GetIDWithSeed(const char* str_id_begin, const char* str_id_end, ImGuiID seed)
{
...
CIMGUI_API bool   cimgui::ImGui_ItemAddEx(cimgui::ImRect bb, ImGuiID id, const cimgui::ImRect* nav_bb)
{
    return ::ImGui::ItemAdd(ConvertToCPP_ImRect(bb), id, reinterpret_cast<const ::ImRect*>(nav_bb));
}

CIMGUI_API bool   cimgui::ImGui_ItemHoverable(cimgui::ImRect bb, ImGuiID id)
{
    return ::ImGui::ItemHoverable(ConvertToCPP_ImRect(bb), id);
}

CIMGUI_API bool   cimgui::ImGui_IsClippedEx(cimgui::ImRect bb, ImGuiID id, bool clip_even_when_logged)
{
    return ::ImGui::IsClippedEx(ConvertToCPP_ImRect(bb), id, clip_even_when_logged);
}

CIMGUI_API void   cimgui::ImGui_SetLastItemData(cimgui::ImGuiWindow* window, ImGuiID item_id, ImGuiItemStatusFlags status_flags, cimgui::ImRect item_rect)
{
    ::ImGui::SetLastItemData(reinterpret_cast<::ImGuiWindow*>(window), item_id, status_flags, ConvertToCPP_ImRect(item_rect));
}
...
CIMGUI_API bool         cimgui::ImGui_BeginChildEx(const char* name, ImGuiID id, cimgui::ImVec2 size_arg, bool border, ImGuiWindowFlags flags)
{
    return ::ImGui::BeginChildEx(name, id, ConvertToCPP_ImVec2(size_arg), border, flags);
}
...
CIMGUI_API void         cimgui::ImGui_BeginTooltipEx(ImGuiWindowFlags extra_flags, ImGuiTooltipFlags tooltip_flags)
{
...
CIMGUI_API void   cimgui::ImGui_NavMoveRequestForward(ImGuiDir move_dir, ImGuiDir clip_dir, cimgui::ImRect bb_rel, ImGuiNavMoveFlags move_flags)
{
    ::ImGui::NavMoveRequestForward(move_dir, clip_dir, ConvertToCPP_ImRect(bb_rel), move_flags);
}
...
CIMGUI_API float  cimgui::ImGui_GetNavInputAmount(ImGuiNavInput n, cimgui::ImGuiInputReadMode mode)
{
    return ::ImGui::GetNavInputAmount(n, static_cast<::ImGuiInputReadMode>(mode));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImGui_GetNavInputAmount2d(ImGuiNavDirSourceFlags dir_sources, cimgui::ImGuiInputReadMode mode)
{
    return ConvertFromCPP_ImVec2(::ImGui::GetNavInputAmount2d(dir_sources, static_cast<::ImGuiInputReadMode>(mode)));
}

CIMGUI_API cimgui::ImVec2 cimgui::ImGui_GetNavInputAmount2dEx(ImGuiNavDirSourceFlags dir_sources, cimgui::ImGuiInputReadMode mode, float slow_factor, float fast_factor)
{
    return ConvertFromCPP_ImVec2(::ImGui::GetNavInputAmount2d(dir_sources, static_cast<::ImGuiInputReadMode>(mode), slow_factor, fast_factor));
}
...
CIMGUI_API void   cimgui::ImGui_ActivateItem(ImGuiID id)
{
    ::ImGui::ActivateItem(id);
}

CIMGUI_API void   cimgui::ImGui_SetNavID(ImGuiID id, int nav_layer, ImGuiID focus_scope_id)
{
    ::ImGui::SetNavID(id, nav_layer, focus_scope_id);
}

CIMGUI_API void   cimgui::ImGui_SetNavIDWithRectRel(ImGuiID id, int nav_layer, ImGuiID focus_scope_id, cimgui::ImRect rect_rel)
{
    ::ImGui::SetNavIDWithRectRel(id, nav_layer, focus_scope_id, ConvertToCPP_ImRect(rect_rel));
}
...
CIMGUI_API ImGuiID cimgui::ImGui_GetFocusedFocusScope(void)
{
    return ::ImGui::GetFocusedFocusScope();
}

CIMGUI_API ImGuiID cimgui::ImGui_GetFocusScope(void)
{
...
CIMGUI_API bool             cimgui::ImGui_IsActiveIdUsingNavInput(ImGuiNavInput input)
{
    return ::ImGui::IsActiveIdUsingNavInput(input);
}

CIMGUI_API bool             cimgui::ImGui_IsActiveIdUsingKey(ImGuiKey key)
{
...
CIMGUI_API bool             cimgui::ImGui_IsKeyPressedMap(ImGuiKey key)
{
    return ::ImGui::IsKeyPressedMap(key);
}

CIMGUI_API bool             cimgui::ImGui_IsKeyPressedMapEx(ImGuiKey key, bool repeat)
{
    return ::ImGui::IsKeyPressedMap(key, repeat);
}

CIMGUI_API bool             cimgui::ImGui_IsNavInputDown(ImGuiNavInput n)
{
    return ::ImGui::IsNavInputDown(n);
}

CIMGUI_API bool             cimgui::ImGui_IsNavInputTest(ImGuiNavInput n, cimgui::ImGuiInputReadMode rm)
{
    return ::ImGui::IsNavInputTest(n, static_cast<::ImGuiInputReadMode>(rm));
}

CIMGUI_API ImGuiKeyModFlags cimgui::ImGui_GetMergedKeyModFlags(void)
{
...
CIMGUI_API void               cimgui::ImGui_TableDrawContextMenu(cimgui::ImGuiTable* table)
{
    ::ImGui::TableDrawContextMenu(reinterpret_cast<::ImGuiTable*>(table));
}
...
CIMGUI_API ImGuiID            cimgui::ImGui_TableGetColumnResizeID(const cimgui::ImGuiTable* table, int column_n)
{
    return ::ImGui::TableGetColumnResizeID(reinterpret_cast<const ::ImGuiTable*>(table), column_n);
}

CIMGUI_API ImGuiID            cimgui::ImGui_TableGetColumnResizeIDEx(const cimgui::ImGuiTable* table, int column_n, int instance_no)
{
    return ::ImGui::TableGetColumnResizeID(reinterpret_cast<const ::ImGuiTable*>(table), column_n, instance_no);
}
...
CIMGUI_API void                cimgui::ImGui_TableSettingsInstallHandler(cimgui::ImGuiContext* context)
{
    ::ImGui::TableSettingsInstallHandler(reinterpret_cast<::ImGuiContext*>(context));
}
...
CIMGUI_API void          cimgui::ImGui_TabBarQueueReorder(cimgui::ImGuiTabBar* tab_bar, const cimgui::ImGuiTabItem* tab, int dir)
{
    ::ImGui::TabBarQueueReorder(reinterpret_cast<::ImGuiTabBar*>(tab_bar), reinterpret_cast<const ::ImGuiTabItem*>(tab), dir);
}
...
CIMGUI_API bool          cimgui::ImGui_TabItemEx(cimgui::ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags)
{
    return ::ImGui::TabItemEx(reinterpret_cast<::ImGuiTabBar*>(tab_bar), label, p_open, flags);
}

CIMGUI_API cimgui::ImVec2 cimgui::ImGui_TabItemCalcSize(const char* label, bool has_close_button)
{
    return ConvertFromCPP_ImVec2(::ImGui::TabItemCalcSize(label, has_close_button));
}
...
CIMGUI_API void        cimgui::ImGui_RenderColorRectWithAlphaCheckerboardEx(cimgui::ImDrawList* draw_list, cimgui::ImVec2 p_min, cimgui::ImVec2 p_max, ImU32 fill_col, float grid_step, cimgui::ImVec2 grid_off, float rounding, int rounding_corners_flags)
{
    ::ImGui::RenderColorRectWithAlphaCheckerboard(reinterpret_cast<::ImDrawList*>(draw_list), ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), fill_col, grid_step, ConvertToCPP_ImVec2(grid_off), rounding, rounding_corners_flags);
}
...
CIMGUI_API void cimgui::ImGui_RenderArrowImDrawListPtr(cimgui::ImDrawList* draw_list, cimgui::ImVec2 pos, ImU32 col, ImGuiDir dir)
{
    ::ImGui::RenderArrow(reinterpret_cast<::ImDrawList*>(draw_list), ConvertToCPP_ImVec2(pos), col, dir);
}

CIMGUI_API void cimgui::ImGui_RenderArrowImDrawListPtrEx(cimgui::ImDrawList* draw_list, cimgui::ImVec2 pos, ImU32 col, ImGuiDir dir, float scale)
{
    ::ImGui::RenderArrow(reinterpret_cast<::ImDrawList*>(draw_list), ConvertToCPP_ImVec2(pos), col, dir, scale);
}

CIMGUI_API void cimgui::ImGui_RenderBulletImDrawListPtr(cimgui::ImDrawList* draw_list, cimgui::ImVec2 pos, ImU32 col)
{
...
CIMGUI_API void cimgui::ImGui_RenderMouseCursor(cimgui::ImDrawList* draw_list, cimgui::ImVec2 pos, float scale, ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow)
{
    ::ImGui::RenderMouseCursor(reinterpret_cast<::ImDrawList*>(draw_list), ConvertToCPP_ImVec2(pos), scale, mouse_cursor, col_fill, col_border, col_shadow);
}
...
CIMGUI_API void cimgui::ImGui_RenderArrow(cimgui::ImVec2 pos, ImGuiDir dir)
{
    ::ImGui::RenderArrow(ConvertToCPP_ImVec2(pos), dir);
}

CIMGUI_API void cimgui::ImGui_RenderArrowEx(cimgui::ImVec2 pos, ImGuiDir dir, float scale)
{
    ::ImGui::RenderArrow(ConvertToCPP_ImVec2(pos), dir, scale);
}

CIMGUI_API void cimgui::ImGui_RenderBullet(cimgui::ImVec2 pos)
{
    ::ImGui::RenderBullet(ConvertToCPP_ImVec2(pos));
}
...
CIMGUI_API bool    cimgui::ImGui_ScrollbarEx(cimgui::ImRect bb, ImGuiID id, cimgui::ImGuiAxis axis, float* p_scroll_v, float avail_v, float contents_v, ImDrawCornerFlags rounding_corners)
{
    return ::ImGui::ScrollbarEx(ConvertToCPP_ImRect(bb), id, static_cast<::ImGuiAxis>(axis), p_scroll_v, avail_v, contents_v, rounding_corners);
}

CIMGUI_API bool    cimgui::ImGui_ImageButtonWithFlags(ImGuiID id, ImTextureID texture_id, cimgui::ImVec2 size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1, cimgui::ImVec2 padding, cimgui::ImVec4 bg_col, cimgui::ImVec4 tint_col)
{
    return ::ImGui::ImageButtonEx(id, texture_id, ConvertToCPP_ImVec2(size), ConvertToCPP_ImVec2(uv0), ConvertToCPP_ImVec2(uv1), ConvertToCPP_ImVec2(padding), ConvertToCPP_ImVec4(bg_col), ConvertToCPP_ImVec4(tint_col));
}
...
CIMGUI_API ImGuiID cimgui::ImGui_GetWindowResizeID(cimgui::ImGuiWindow* window, int n)
{
    return ::ImGui::GetWindowResizeID(reinterpret_cast<::ImGuiWindow*>(window), n);
}
...
CIMGUI_API bool cimgui::ImGui_SplitterBehaviorEx(cimgui::ImRect bb, ImGuiID id, cimgui::ImGuiAxis axis, float* size1, float* size2, float min_size1, float min_size2, float hover_extend, float hover_visibility_delay)
{
    return ::ImGui::SplitterBehavior(ConvertToCPP_ImRect(bb), id, static_cast<::ImGuiAxis>(axis), size1, size2, min_size1, min_size2, hover_extend, hover_visibility_delay);
}
...
CIMGUI_API bool                     cimgui::ImGui_DataTypeApplyOpFromText(const char* buf, const char* initial_value_buf, ImGuiDataType data_type, void* p_data, const char* format)
{
...
CIMGUI_API int cimgui::ImGui_PlotEx(cimgui::ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, cimgui::ImVec2 frame_size)
{
    return ::ImGui::PlotEx(static_cast<::ImGuiPlotType>(plot_type), label, values_getter, data, values_count, values_offset, overlay_text, scale_min, scale_max, ConvertToCPP_ImVec2(frame_size));
}
...
CIMGUI_API void cimgui::ImGui_DebugNodeDrawList(cimgui::ImGuiWindow* window, const cimgui::ImDrawList* draw_list, const char* label)
{
    ::ImGui::DebugNodeDrawList(reinterpret_cast<::ImGuiWindow*>(window), reinterpret_cast<const ::ImDrawList*>(draw_list), label);
}

CIMGUI_API void cimgui::ImGui_DebugNodeDrawCmdShowMeshAndBoundingBox(cimgui::ImGuiWindow* window, const cimgui::ImDrawList* draw_list, const cimgui::ImDrawCmd* draw_cmd, bool show_mesh, bool show_aabb)
{
    ::ImGui::DebugNodeDrawCmdShowMeshAndBoundingBox(reinterpret_cast<::ImGuiWindow*>(window), reinterpret_cast<const ::ImDrawList*>(draw_list), reinterpret_cast<const ::ImDrawCmd*>(draw_cmd), show_mesh, show_aabb);
}
...
CIMGUI_API bool cimgui::cImFontAtlasBuildWithStbTruetype(cimgui::ImFontAtlas* atlas)
{
    return ::ImFontAtlasBuildWithStbTruetype(reinterpret_cast<::ImFontAtlas*>(atlas));
}
...
CIMGUI_API void cimgui::cImFontAtlasBuildRender1bppRectFromString(cimgui::ImFontAtlas* atlas, int atlas_x, int atlas_y, int w, int h, const char* in_str, char in_marker_char, unsigned char in_marker_pixel_value)
{
    ::ImFontAtlasBuildRender1bppRectFromString(reinterpret_cast<::ImFontAtlas*>(atlas), atlas_x, atlas_y, w, h, in_str, in_marker_char, in_marker_pixel_value);
}
...
CIMGUI_API void cimgui::cImGuiTestEngineHook_ItemAdd(cimgui::ImGuiContext* ctx, cimgui::ImRect bb, ImGuiID id)
{
    ::ImGuiTestEngineHook_ItemAdd(reinterpret_cast<::ImGuiContext*>(ctx), ConvertToCPP_ImRect(bb), id);
}
...
CIMGUI_API void cimgui::cImGuiTestEngineHook_IdInfo(cimgui::ImGuiContext* ctx, ImGuiDataType data_type, ImGuiID id, const void* data_id)
{
    ::ImGuiTestEngineHook_IdInfo(reinterpret_cast<::ImGuiContext*>(ctx), data_type, id, data_id);
}

CIMGUI_API void cimgui::cImGuiTestEngineHook_IdInfoPtr(cimgui::ImGuiContext* ctx, ImGuiDataType data_type, ImGuiID id, const void* data_id, const void* data_id_end)
{
    ::ImGuiTestEngineHook_IdInfo(reinterpret_cast<::ImGuiContext*>(ctx), data_type, id, data_id, data_id_end);
}
