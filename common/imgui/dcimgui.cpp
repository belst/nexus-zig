...
CIMGUI_API bool cimgui::ImGui_ImageButton(ImTextureID user_texture_id, cimgui::ImVec2 size)
{
    return ::ImGui::ImageButton(user_texture_id, ConvertToCPP_ImVec2(size));
}

CIMGUI_API bool cimgui::ImGui_ImageButtonEx(ImTextureID user_texture_id, cimgui::ImVec2 size, cimgui::ImVec2 uv0, cimgui::ImVec2 uv1, int frame_padding, cimgui::ImVec4 bg_col, cimgui::ImVec4 tint_col)
{
...
CIMGUI_API bool cimgui::ImGui_DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed)
{
    return ::ImGui::DragScalar(label, data_type, p_data, v_speed);
}
...
CIMGUI_API bool cimgui::ImGui_DragScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, float v_speed)
{
...
CIMGUI_API void                  cimgui::ImGui_TableSetupColumnEx(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImU32 user_id)
{
...
CIMGUI_API int  cimgui::ImGui_GetKeyIndex(ImGuiKey imgui_key)
{
    return ::ImGui::GetKeyIndex(imgui_key);
}

CIMGUI_API bool cimgui::ImGui_IsKeyDown(int user_key_index)
{
    return ::ImGui::IsKeyDown(user_key_index);
}

CIMGUI_API bool cimgui::ImGui_IsKeyPressed(int user_key_index)
{
    return ::ImGui::IsKeyPressed(user_key_index);
}

CIMGUI_API bool cimgui::ImGui_IsKeyPressedEx(int user_key_index, bool repeat)
{
    return ::ImGui::IsKeyPressed(user_key_index, repeat);
}

CIMGUI_API bool cimgui::ImGui_IsKeyReleased(int user_key_index)
{
    return ::ImGui::IsKeyReleased(user_key_index);
}

CIMGUI_API int  cimgui::ImGui_GetKeyPressedAmount(int key_index, float repeat_delay, float rate)
{
    return ::ImGui::GetKeyPressedAmount(key_index, repeat_delay, rate);
}

CIMGUI_API void cimgui::ImGui_CaptureKeyboardFromApp(bool want_capture_keyboard_value)
{
...
CIMGUI_API void             cimgui::ImGui_CaptureMouseFromApp(bool want_capture_mouse_value)
{
...
CIMGUI_API void  cimgui::ImGui_SetAllocatorFunctions(void* (*alloc_func)(size_t sz, void* user_data), void (*free_func)(void* ptr, void* user_data), void* user_data)
{
...
CIMGUI_API bool        cimgui::ImGui_DragScalarFloat(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
    return ::ImGui::DragScalar(label, data_type, p_data, v_speed, p_min, p_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_DragScalarNFloat(const char* label, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
    return ::ImGui::DragScalarN(label, data_type, p_data, components, v_speed, p_min, p_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_DragFloatFloat(const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::DragFloat(label, v, v_speed, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_DragFloat2Float(const char* label, float v[2], float v_speed, float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::DragFloat2(label, v, v_speed, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_DragFloat3Float(const char* label, float v[3], float v_speed, float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::DragFloat3(label, v, v_speed, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_DragFloat4Float(const char* label, float v[4], float v_speed, float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::DragFloat4(label, v, v_speed, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderScalarFloat(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power)
{
    return ::ImGui::SliderScalar(label, data_type, p_data, p_min, p_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderScalarNFloat(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char* format, float power)
{
    return ::ImGui::SliderScalarN(label, data_type, p_data, components, p_min, p_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderFloatFloat(const char* label, float* v, float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::SliderFloat(label, v, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderFloat2Float(const char* label, float v[2], float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::SliderFloat2(label, v, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderFloat3Float(const char* label, float v[3], float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::SliderFloat3(label, v, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_SliderFloat4Float(const char* label, float v[4], float v_min, float v_max, const char* format, float power)
{
    return ::ImGui::SliderFloat4(label, v, v_min, v_max, format, power);
}

CIMGUI_API bool        cimgui::ImGui_BeginPopupContextWindowImGuiMouseButton(const char* str_id, ImGuiMouseButton mb, bool over_items)
{
    return ::ImGui::BeginPopupContextWindow(str_id, mb, over_items);
}

CIMGUI_API void        cimgui::ImGui_TreeAdvanceToLabelPos(void)
{
    ::ImGui::TreeAdvanceToLabelPos();
}

CIMGUI_API void        cimgui::ImGui_SetNextTreeNodeOpen(bool open, ImGuiCond cond)
{
    ::ImGui::SetNextTreeNodeOpen(open, cond);
}

CIMGUI_API float       cimgui::ImGui_GetContentRegionAvailWidth(void)
{
    return ::ImGui::GetContentRegionAvailWidth();
}

CIMGUI_API cimgui::ImDrawList* cimgui::ImGui_GetOverlayDrawList(void)
{
    return reinterpret_cast<::cimgui::ImDrawList*>(::ImGui::GetOverlayDrawList());
}

CIMGUI_API void        cimgui::ImGui_SetScrollHere(void)
{
    ::ImGui::SetScrollHere();
}

CIMGUI_API void        cimgui::ImGui_SetScrollHereEx(float center_ratio)
{
...
CIMGUI_API void        cimgui::ImDrawList_AddRectEx(cimgui::ImDrawList* self, cimgui::ImVec2 p_min, cimgui::ImVec2 p_max, ImU32 col, float rounding, ImDrawCornerFlags rounding_corners, float thickness)
{
    reinterpret_cast<::ImDrawList*>(self)->AddRect(ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), col, rounding, rounding_corners, thickness);
}
...
CIMGUI_API void        cimgui::ImDrawList_AddRectFilledEx(cimgui::ImDrawList* self, cimgui::ImVec2 p_min, cimgui::ImVec2 p_max, ImU32 col, float rounding, ImDrawCornerFlags rounding_corners)
{
    reinterpret_cast<::ImDrawList*>(self)->AddRectFilled(ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), col, rounding, rounding_corners);
}
...
CIMGUI_API void        cimgui::ImDrawList_AddPolyline(cimgui::ImDrawList* self, const cimgui::ImVec2* points, int num_points, ImU32 col, bool closed, float thickness)
{
    reinterpret_cast<::ImDrawList*>(self)->AddPolyline(reinterpret_cast<const ::ImVec2*>(points), num_points, col, closed, thickness);
}
...
CIMGUI_API void        cimgui::ImDrawList_AddImageRounded(cimgui::ImDrawList* self, ImTextureID user_texture_id, cimgui::ImVec2 p_min, cimgui::ImVec2 p_max, cimgui::ImVec2 uv_min, cimgui::ImVec2 uv_max, ImU32 col, float rounding)
{
    reinterpret_cast<::ImDrawList*>(self)->AddImageRounded(user_texture_id, ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), ConvertToCPP_ImVec2(uv_min), ConvertToCPP_ImVec2(uv_max), col, rounding);
}

CIMGUI_API void        cimgui::ImDrawList_AddImageRoundedEx(cimgui::ImDrawList* self, ImTextureID user_texture_id, cimgui::ImVec2 p_min, cimgui::ImVec2 p_max, cimgui::ImVec2 uv_min, cimgui::ImVec2 uv_max, ImU32 col, float rounding, ImDrawCornerFlags rounding_corners)
{
    reinterpret_cast<::ImDrawList*>(self)->AddImageRounded(user_texture_id, ConvertToCPP_ImVec2(p_min), ConvertToCPP_ImVec2(p_max), ConvertToCPP_ImVec2(uv_min), ConvertToCPP_ImVec2(uv_max), col, rounding, rounding_corners);
}
...
CIMGUI_API void        cimgui::ImDrawList_PathStroke(cimgui::ImDrawList* self, ImU32 col, bool closed, float thickness)
{
    reinterpret_cast<::ImDrawList*>(self)->PathStroke(col, closed, thickness);
}
...
CIMGUI_API void        cimgui::ImDrawList_PathRect(cimgui::ImDrawList* self, cimgui::ImVec2 rect_min, cimgui::ImVec2 rect_max, float rounding, ImDrawCornerFlags rounding_corners)
{
    reinterpret_cast<::ImDrawList*>(self)->PathRect(ConvertToCPP_ImVec2(rect_min), ConvertToCPP_ImVec2(rect_max), rounding, rounding_corners);
}
...
CIMGUI_API void               cimgui::ImFont_SetFallbackChar(cimgui::ImFont* self, ImWchar c)
{
    reinterpret_cast<::ImFont*>(self)->SetFallbackChar(c);
}
